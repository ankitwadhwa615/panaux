...
// import 'package:panaux_customer/screens/orders/widgets/change_dispatched_status.dart';
import 'package:panaux_customer/screens/orders/widgets/full_screen_image.dart';

class DispatchedOrderDetails extends StatefulWidget {
  final String id;
  const DispatchedOrderDetails({Key? key, required this.id}) : super(key: key);

  @override
  State<DispatchedOrderDetails> createState() => _DispatchedOrderDetailsState();
}

class _DispatchedOrderDetailsState extends State<DispatchedOrderDetails>
    ...
    return Obx(
      () => ModalProgressHUD(
        ...
        child: Scaffold(
          ...
          // 	child: TabBarView(
          // 		controllers: tabController,
          // 		children: [orderDetails(),  const ChangeDispatchedStatus()],
          // 	),
          // )
          body: orderDetails(),
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () async {
                    ...
                    await controller.setDelivered(widget.id);
  ...
  Widget userDetails() {
    return Column(
      children: [
                    ...
                    children: [
                      ...
                      Text(
                        controller.orderDetails!.client!.addressess!.isEmpty
                            ? ""
                            : controller.orderDetails!.client!.addressess![0]
                                .addressLine1!,
                        style: const TextStyle(
                            color: Colors.black,
                            fontSize: 14,
        ...
        controller.orderDetails?.product?.length == 0
            ? const SizedBox()
            : productList(),
        controller.orderDetails?.driverName != ""
            ? driverDetails()
            : const SizedBox(),
      ],
    );
                  ...
                  child: Row(
                    ...
                    children: [
                      SizedBox(
                          width: 120,
                          height: 120,
                          child: Image.network(controller.orderDetails!
                              .product![index].product!.image![0])),
                      Container(
                        padding:
                        ...
                        child: Column(
                          ...
                          children: [
                            SizedBox(
                              width: 150,
                              child: Text(
                                controller.orderDetails!.product![index]
                                    .product!.title!,
                            ...
                            Text(
                              "Total Amount: ₹" +
                                  (controller.orderDetails!.product![index]
                                              .product!.price! *
                                          (num.parse(controller.orderDetails!
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    controller.orderDetails?.driverNumber ?? "",
                    style: const TextStyle(
                        color: Colors.black,
                        fontSize: 14,
                        fontWeight: FontWeight.w600),
