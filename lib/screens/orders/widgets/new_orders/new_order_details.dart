...
import 'package:panaux_customer/screens/orders/widgets/new_orders/add_product.dart';
          ...
          body: Column(
            children: [
              ...
              Expanded(
                child: TabBarView(
                  controller: tabController,
                  children: [orderDetails(), const AddProduct()],
                ),
              )
            ],
          ),
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () async {
                      ...
                      await productController.saveProducts(widget.id);
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Hero(
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.network(
                                          controller.orderDetails!.prescription==null?"": controller.orderDetails!.prescription!,
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
